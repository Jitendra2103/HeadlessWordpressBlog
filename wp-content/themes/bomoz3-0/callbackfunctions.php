...
function getAllPosts()
{
    ...
    return  ['success' => true, 'message' => 'Posts retrived successfully.', 'result' => $posts, 'status' => 200];
}
...
function describePost(WP_REST_Request $request)
{
    ...
    if ($postId == '' || empty($postId)) {
        ...
        if (empty($post)) {
            ...
            $response = ['success' => true, 'message' => 'Post data retrived successfully.', 'result' => $posts, 'status' => 200];
        }
    }
    return $response;
}
